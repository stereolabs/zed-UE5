...
void EmptyLinkFunctionForGeneratedCodeStereolabs_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_Stereolabs()
	{
		if (!Z_Registration_Info_UPackage__Script_Stereolabs.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_Stereolabs_SlCameraProxyRetrieveObjectDelegate__DelegateSignature,
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_Stereolabs(Z_Construct_UPackage__Script_Stereolabs, TEXT("/Script/Stereolabs"), Z_Registration_Info_UPackage__Script_Stereolabs, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x10A5B019, 0xA9FC28E0));
