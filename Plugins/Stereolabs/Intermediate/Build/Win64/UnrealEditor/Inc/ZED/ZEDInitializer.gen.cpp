...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AZEDInitializer_Statics::NewProp_bUseHMDTrackingAsOrigin_MetaData[] = {
		{ "Category", "Zed" },
		{ "Comment", "/*\n\x09 * Use the HMD transform as tracking origin, else the HMD tracking origin is reset.\n\x09 * Enable if the player must match his real world location/rotation. \n\x09 * Not loaded from config file\n\x09 */" },
		{ "ModuleRelativePath", "Public/Core/ZEDInitializer.h" },
		{ "ToolTip", "* Use the HMD transform as tracking origin, else the HMD tracking origin is reset.\n* Enable if the player must match his real world location/rotation.\n* Not loaded from config file" },
	};
#endif
	void Z_Construct_UClass_AZEDInitializer_Statics::NewProp_bUseHMDTrackingAsOrigin_SetBit(void* Obj)
	{
		((AZEDInitializer*)Obj)->bUseHMDTrackingAsOrigin = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AZEDInitializer_Statics::NewProp_bUseHMDTrackingAsOrigin = { "bUseHMDTrackingAsOrigin", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(AZEDInitializer), &Z_Construct_UClass_AZEDInitializer_Statics::NewProp_bUseHMDTrackingAsOrigin_SetBit, METADATA_PARAMS(Z_Construct_UClass_AZEDInitializer_Statics::NewProp_bUseHMDTrackingAsOrigin_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AZEDInitializer_Statics::NewProp_bUseHMDTrackingAsOrigin_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AZEDInitializer_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AZEDInitializer_Statics::NewProp_bUseHMDTrackingAsOrigin,
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_zed_UE5_Plugins_Stereolabs_Source_ZED_Public_Core_ZEDInitializer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AZEDInitializer, AZEDInitializer::StaticClass, TEXT("AZEDInitializer"), &Z_Registration_Info_UClass_AZEDInitializer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AZEDInitializer), 438370748U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_zed_UE5_Plugins_Stereolabs_Source_ZED_Public_Core_ZEDInitializer_h_3501727321(TEXT("/Script/ZED"),
