...
// End Cross Module References
	...
	DEFINE_FUNCTION(AZEDCamera::execDisableObjectDetection)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(AZEDCamera::execEnableObjectDetection)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->EnableObjectDetection();
		P_NATIVE_END;
	}
	...
	void AZEDCamera::StaticRegisterNativesAZEDCamera()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "DisableObjectDetection", &AZEDCamera::execDisableObjectDetection },
			{ "DisableSVORecording", &AZEDCamera::execDisableSVORecording },
			{ "DisableTracking", &AZEDCamera::execDisableTracking },
			{ "EnableObjectDetection", &AZEDCamera::execEnableObjectDetection },
	...
	struct Z_Construct_UFunction_AZEDCamera_DisableObjectDetection_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AZEDCamera_DisableObjectDetection_Statics::Function_MetaDataParams[] = {
		{ "Category", "Zed|Object Detection" },
		{ "Comment", "/*\n\x09 * Disable object detection\n\x09 */" },
		{ "ModuleRelativePath", "Public/Core/ZEDCamera.h" },
		{ "ToolTip", "* Disable object detection" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AZEDCamera_DisableObjectDetection_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AZEDCamera, nullptr, "DisableObjectDetection", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AZEDCamera_DisableObjectDetection_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_AZEDCamera_DisableObjectDetection_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AZEDCamera_DisableObjectDetection()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AZEDCamera_DisableObjectDetection_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_AZEDCamera_EnableObjectDetection_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AZEDCamera_EnableObjectDetection_Statics::Function_MetaDataParams[] = {
		{ "Category", "Zed|Object Detection" },
		{ "Comment", "/*\n\x09*Enable object detection using current object detection parameters\n\x09*/" },
		{ "ModuleRelativePath", "Public/Core/ZEDCamera.h" },
		{ "ToolTip", "*Enable object detection using current object detection parameters" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AZEDCamera_EnableObjectDetection_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AZEDCamera, nullptr, "EnableObjectDetection", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AZEDCamera_EnableObjectDetection_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_AZEDCamera_EnableObjectDetection_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AZEDCamera_EnableObjectDetection()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AZEDCamera_EnableObjectDetection_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AZEDCamera_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_AZEDCamera_DisableObjectDetection, "DisableObjectDetection" }, // 2033155765
		...
		{ &Z_Construct_UFunction_AZEDCamera_EnableObjectDetection, "EnableObjectDetection" }, // 1388706834
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AZEDCamera_Statics::NewProp_ObjectDetectionParameters_MetaData[] = {
		{ "Category", "Zed" },
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AZEDCamera_Statics::NewProp_ObjectDetectionParameters = { "ObjectDetectionParameters", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AZEDCamera, ObjectDetectionParameters), Z_Construct_UScriptStruct_FSlObjectDetectionParameters, METADATA_PARAMS(Z_Construct_UClass_AZEDCamera_Statics::NewProp_ObjectDetectionParameters_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AZEDCamera_Statics::NewProp_ObjectDetectionParameters_MetaData)) }; // 2617711556
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AZEDCamera_Statics::NewProp_ObjectDetectionRuntimeParameters_MetaData[] = {
		{ "Category", "Zed" },
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AZEDCamera_Statics::NewProp_ObjectDetectionRuntimeParameters = { "ObjectDetectionRuntimeParameters", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AZEDCamera, ObjectDetectionRuntimeParameters), Z_Construct_UScriptStruct_FSlObjectDetectionRuntimeParameters, METADATA_PARAMS(Z_Construct_UClass_AZEDCamera_Statics::NewProp_ObjectDetectionRuntimeParameters_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AZEDCamera_Statics::NewProp_ObjectDetectionRuntimeParameters_MetaData)) }; // 3422687885
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AZEDCamera_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AZEDCamera_Statics::NewProp_ObjectDetectionParameters,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AZEDCamera_Statics::NewProp_ObjectDetectionRuntimeParameters,
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_zed_UE5_Plugins_Stereolabs_Source_ZED_Public_Core_ZEDCamera_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AZEDCamera, AZEDCamera::StaticClass, TEXT("AZEDCamera"), &Z_Registration_Info_UClass_AZEDCamera, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AZEDCamera), 3231644576U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_zed_UE5_Plugins_Stereolabs_Source_ZED_Public_Core_ZEDCamera_h_1658882465(TEXT("/Script/ZED"),
