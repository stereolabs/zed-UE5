 ...
 ****************************************************************************/
#ifndef SLGO_STUFF_API_H
#define SLGO_STUFF_API_H
...
#ifdef stuff_EXPORTS
#define SLGO_STUFF_API __declspec(dllexport)
#else
#define SLGO_STUFF_API __declspec(dllimport)
#endif
#else
#define SLGO_STUFF_API
#endif
